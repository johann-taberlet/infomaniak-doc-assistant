...
This guide explains how to get event reminders from the Infomaniak Web app **Calendar** (online service [ksuite.infomaniak.com/calendar](https://ksuite.infomaniak.com/calendar)) on a chat system like [kChat](https://infomaniak.com/gtl/kchat) or Slack.

...
- [AppleiCloud](https://www.infomaniak.com/en/support/faq/2515): complete guide to migrate **iCloud** data to Infomaniak
...
- OwnCloud
- NextCloud
- Any device with a **WebDAV** service including **external kDrive** (refer to [this other guide](https://www.infomaniak.com/en/support/faq/2557))
...
> **Note:** A second consecutive import would re-import all the data (to another kDrive directory), it is not differential synchronization and there is no duplicate management.

...
This guide details the installation of the desktop app [kDrive](https://infomaniak.com/gtl/kdrive) Infomaniak on a computer with a **Linux** operating system. It will then allow you to synchronize your files with kDrive.
...
- [Download](https://infomaniak.com/gtl/apps.kdrive) the desktop app **kDrive** for Linux*(file of type .AppImage)*

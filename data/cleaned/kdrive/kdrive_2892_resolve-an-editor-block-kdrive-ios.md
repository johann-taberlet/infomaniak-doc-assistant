# Resolve an editor block (k Drive iOS)

Source: https://www.infomaniak.com/en/support/faq/2892/resolve-an-editor-block-kdrive-ios

---

This guide explains how to resolve issues with opening the integrated document editor in the k Drive mobile app on iOS (i Phone / i Pad).

### Preamble

- On iOS and i PadOS, the k Drive app uses a secure web view to launch the editor.
...
If, when you try to edit a document (Word, Excel, Power Point) from the k Drive app on iOS:
...
Once these exceptions are added, go back to the k Drive app to relaunch the document editing.

# Fixing an “Unrecognized Device” Error

Source: https://www.infomaniak.com/en/support/faq/2685/fixing-an-unrecognized-device-error

---

This guide addresses connection issues with Infomaniak on certain mobile apps like **Euria** or **k Drive** when the error “your device is not recognized as safe” occurs.

## Android security standards (Google Play Integrity)

Some users are currently encountering an error message “Your device is not recognized as safe” when connecting to mobile apps (k Drive, Euria, Swiss Transfer) on Android…

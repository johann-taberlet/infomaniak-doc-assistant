...
One of the simplest ways to replace Skype is to adopt [kMeet](https://www.infomaniak.com/en/support/faq/2474):
...
The alternative **kMeet** to replace Skype can be implemented in different ways:

### 1. Quick use without registration

To start a private communication between several people on the Internet, it is enough for one of them to go to kMeet and then communicate the meeting link to the others. Here is the step-by-step procedure:
